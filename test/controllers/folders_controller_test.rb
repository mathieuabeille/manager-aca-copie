...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { managerAccess: @folder.managerAccess, name: @folder.name, order: @folder.order } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { managerAccess: @folder.managerAccess, name: @folder.name, order: @folder.order } }
