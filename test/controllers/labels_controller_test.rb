...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { description: @label.description, labeltype: @label.labeltype, name: @label.name, price: @label.price } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { description: @label.description, labeltype: @label.labeltype, name: @label.name, price: @label.price } }
